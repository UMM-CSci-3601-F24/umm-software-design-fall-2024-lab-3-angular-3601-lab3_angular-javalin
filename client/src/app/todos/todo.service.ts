...
export class UserService {
   ...
   */
  getUsers(filters?: { role?: TodoRole; status?: boolean; owner?: string; body?: string; category?: string }): Observable<Todo[]> {
    ...
    if (filters) {
      ...
      if (filters.body) {
        httpParams = httpParams.set('body', filters.body.toString());
      }
      if (filters.category) {
